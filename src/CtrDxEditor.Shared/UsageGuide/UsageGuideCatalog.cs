...
namespace CtrDxEditor.UsageGuide
{
    ...
    public static class UsageGuideCatalog
    {
        ...
        [
            ...
            Article("axes", "GameObjects",
                [Para("axes", "InGame"), Para("axes", "Editing"), Para("axes", "Chains"), Warning("axes", "Hazard")],
                ["rope-hooks", "pause-switchers", "objectives"]),
            Article("pause-switchers", "GameObjects",
                [Para("pause-switchers", "InGame"), Para("pause-switchers", "Editing"), Note("pause-switchers", "Overlay")],
                ["axes", "motion", "object-reference"]),
            Article("bombs", "GameObjects",
                [Para("bombs", "InGame"), Para("bombs", "Editing"), Para("bombs", "Ropes"), Warning("bombs", "Blast")],
                ["axes", "rope-hooks", "objectives"]),
