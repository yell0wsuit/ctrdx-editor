...
namespace CtrDxEditor.Content
{
    ...
    {
        /// <summary>Downloads the bundle from the release, reporting the current stage and (while downloading) fractional progress in [0, 1].</summary>
        Task InstallFromDownloadAsync(IProgress<InstallProgress>? progress, CancellationToken ct);
