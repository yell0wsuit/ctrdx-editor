...
namespace CtrDxEditor.Core.Tests
{
    ...
    public class TutorialValidationTests
    {
        ...
        [InlineData("""<tutorial01 x="1" y="1" inArea="0,0,1e100,1" />""", "Validation.Tutorial.InvalidArea")]
        ...
        [InlineData("""<tutorial01 x="1" y="1" angle="1e100" />""", "Validation.Tutorial.InvalidAngle")]
        [InlineData("""<tutorial01 x="1" y="1" moveSpeed="0" />""", "Validation.Tutorial.InvalidMultiplier")]
        [InlineData("""<tutorial01 x="1" y="1" moveSpeed="1e-50" />""", "Validation.Tutorial.InvalidMultiplier")]
