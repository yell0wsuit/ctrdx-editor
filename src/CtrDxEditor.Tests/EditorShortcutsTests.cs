...
namespace CtrDxEditor.Tests
{
    ...
    public class EditorShortcutsTests
    {
        ...
        [InlineData(Key.C, KeyModifiers.Control, EditorShortcut.Copy)]
        [InlineData(Key.X, KeyModifiers.Control, EditorShortcut.Cut)]
        [InlineData(Key.V, KeyModifiers.Control, EditorShortcut.Paste)]
